...
LRESULT CALLBACK WndProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam) {
	...
	case WM_MOUSEMOVE:
	{
		...
		short xCenter = static_cast<short>(sAppState.mWindowWidth / 2);
		short yCenter = static_cast<short>(sAppState.mWindowHeight / 2);

		sCameraController.UpdateRotation(xPos - xCenter, yPos - yCenter);
